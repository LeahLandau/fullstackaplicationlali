...
const Submit = () => {
    ...
    const { imagePath, polygonFrame, setResponse, inputsRef, submitRef, loaderRef, responseRef } = useContext(ImgContext);
    ...
    const handleClick = async (e) => {
        ...
        const response =  await axios.post('http://localhost:5000/api/blackening_pixels', imageDetails)
        setTimeout(() => {
    ...
    return <>
        <div ref={submitRef}>
            <button onClick={(e) => handleClick(e)}>שלח לצינזור</button>
        </div>
