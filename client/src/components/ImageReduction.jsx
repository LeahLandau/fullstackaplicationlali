...
const ImageReduction = () => {
  ...
  const handleClick = async () => {
    const paths = {
      ...
      file_path_jpeg: `${ServerConfig.VOLUME_NAME}/jpeg/convert.jpeg`
    };
  ...
  return <>
    <div className={css.wrraper}>
      ...
      <div>
        ...
        {showNewComponent && polygonFrame.length > 0 && <Submit changeState={changeState} imagePath={imagePath} polygonFrame={polygonFrame} setResponse={setResponse} inputsRef={inputsRef} submitRef={submitRef} loaderRef={loaderRef} responseRef={responseRef} />}
