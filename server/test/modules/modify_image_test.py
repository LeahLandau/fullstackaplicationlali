...
class TestModifyImage(unittest.TestCase):
    ...
    def test_file_is_not_jp2_image(self):
        with self.assertRaises(Exception) as context:
           modify_image('input/cake.jpg', np.array([[5,1] ,[6,1], [7,2], [8,2] ,[9,1], [9,2] ,[9,3], [8,4], [7,5], [6,4], [6,3], [5,3] ,[4,2]]))
...
class TestOpenReadWriteImage(unittest.TestCase):
    ...
    def test_the_image_is_not_exist(self):
        ...
        self.assertEqual(str(context.exception), 'input/cake.jp2: No such file or directory')
...
class TestBlackeningPixels(unittest.TestCase):
    ...
    def test_failed_to_blackening_pixels(self):      
        ...
        self.assertEqual(str(context.exception), "'str' object does not support item assignment")
